...
namespace PrismBlankApp.Modules.Main
{
  public class MainWindowViewModel : BindableBase
  {
    ...
    private void Back()
    {
      ...
      {
        ShowPromptDialog("There is no upper level");
        return;
      }
    ...
    public void ShowPromptDialog(string msg)
    {
      ...
      _dialogService.ShowDialog("MyDialog", dialogParameters, callback => { });
    }

    public void OpenDialog(string obj)
    {
      string str = (string)Application.Current.FindResource("welcome");
      DialogParameters dialogParameters = new DialogParameters
      {
        { "Title", "Test Dialog" },
        { "Content", str }  // Application.Current.Resources
      };
